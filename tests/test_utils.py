...
def test_multi_pieces():
    ...
    numpy.testing.assert_equal(utils._form_iterables_multisource(7,4,w,x,y,y,zs), [w_arr, x_arr, y_arr, y_arr, zs_arr])
...
def test_reshape_multisource():
    ...
    numpy.testing.assert_equal(func(None,w,x,y,z,zs), numpy.sum(zs.reshape((-1,1,1))*ans, axis=0))
    numpy.testing.assert_equal(func(None,w,x,y,z,z_source_pdf=zs), 
                               numpy.sum(zs.reshape((-1,1,1))*ans, axis=0))
